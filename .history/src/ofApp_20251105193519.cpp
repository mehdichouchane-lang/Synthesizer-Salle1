...
void ofApp::draw(){
	...
	ofSetColor(225);
	ofDrawBitmapString("ArTeK 808", 32, 25);
...
ofDrawBitmapString("Note active: " + ofToString(targetFrequency, 2) + " Hz", 31, 470);
ofDrawBitmapString("Octave active: " + ofToString(octaveShift / 12), 500, 470);

ofDrawBitmapString("Clavier: Q W E R T Y U I O P -> 10 notes (C4 to E5)", 32, 490);
ofDrawBitmapString(" press a to >> Octive! ", 500, 490);
ofDrawBitmapString(" press b to << Octive! ", 500, 510);
